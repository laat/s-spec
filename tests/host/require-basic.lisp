(test "require evaluates once and uses global cache"
  ...
  (assert/equal (require "fixtures/require/once.lisp") nil)
...
(test "require resolves paths relative to caller file"
  ...
  (assert/equal (require "fixtures/require/nested/parent.lisp") nil)
...
(test "require works with defmacroonce modules"
  ...
  (assert/equal (require "fixtures/require/macro-once.lisp") nil)
